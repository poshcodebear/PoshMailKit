...
FileList = @('MailKit.dll', 'MimeKit.dll', 'BouncyCastle.Crypto.dll', 'PoshMailKit.dll', 'System.Buffers.dll',
    'System.Management.Automation.dll', 'System.IO.Abstractions.dll')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'https://github.com/poshcodebear/PoshMailKit/releases/tag/v0.9.2-beta'
